...
public abstract class ListaGenerica<T> {
	 ...
	 * que la lista empieza en la posicion 1.
	 * 
	 ...
	 * dicha posicion, el mismo se reubicará a continuación del elemento que vamos a
	 * agregar. Si pudo eliminarlo devuelve true, false en caso contrario.
	 * 
